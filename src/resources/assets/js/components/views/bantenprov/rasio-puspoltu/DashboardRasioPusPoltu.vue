          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <rasio-puspoltu-bar-03></rasio-puspoltu-bar-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
        ...
        <div class="card card-media text-white bg-success">
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <rasio-puspoltu-pie-03></rasio-puspoltu-pie-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Rasio Puskesmas Poliklinik Pustu Berdasarkan Wilayah
            </div>
            <div class="card-body">
              <rasio-puspoltu-bar-01></rasio-puspoltu-bar-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
        ...
        <div class="col-md-4">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <rasio-puspoltu-pie-01></rasio-puspoltu-pie-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-pie-chart" aria-hidden="true"></i>
            Rasio Puskesmas Poliklinik Pustu Berdasarkan Tahun
          </div>
          <div class="card-body">
            <rasio-puspoltu-pie-02></rasio-puspoltu-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /.col -->
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <rasio-puspoltu-bar-02></rasio-puspoltu-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
